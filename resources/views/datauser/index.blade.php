        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div
                    ...
                    <div>
                        <a href="{{ route('datauser.add') }}" id="addBtn"
                        ...
                        @foreach ($users as $user)
                            <tr
                                ...
                                <th scope="row"
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="{{asset('assets/user/default.png')}}"
                                        alt="Jese image">
                                    <div class="ps-3">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('datauser.edit', ['id' => $user->id]) }}"
                                    ...
                                    <a href="{{ route('datauser.delete', ['id' => $user->id]) }}"
