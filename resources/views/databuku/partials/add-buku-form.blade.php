                    ...
                    <form method="POST" action="{{ route('databuku.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="judul" name="judul"
                                ...
                                placeholder="Marmut Merah Jambu" required>
                        </div>
                        <div class="mb-5">
                            <label for="kategori"
                        ...
                        <div class="mb-5">
                            <label for="deskripsi"
                                ...
                                Buku</label>
                            <input type="text" id="deskripsi" name="deskripsi" placeholder="Buku ini menceritakan tentang.."
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                        </div>
                        <div class="mb-5">
                            ...
                            <input type="number" id="jumlah" name="jumlah" placeholder="4"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                        </div>
                        <div class="mb-5 max-w-lg mx-auto">
                            ...
                            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_buku_help">
                                File harus menggunakan format yang sesuai (PDF)</div>
                        </div>
                        <div class="mb-5 max-w-lg mx-auto">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            ...
                            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="cover_buku_help">
                                Fover harus menggunakan format yang sesuai dengan ukuran maks 2mb (jpeg/jpg/png)</div>
                        </div>
                        <button type="submit"
